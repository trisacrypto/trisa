...
var file_trisa_gds_models_v1beta1_ca_proto_goTypes = []any{
...
func file_trisa_gds_models_v1beta1_ca_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_trisa_gds_models_v1beta1_ca_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_trisa_gds_models_v1beta1_ca_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Name); i {
			case 0:
				return &v.state
			case 1:
