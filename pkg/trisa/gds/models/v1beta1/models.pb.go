...
type VASPCategory int32

const (
	VASPCategory_UNKNOWN_VASP       VASPCategory = 0
	VASPCategory_ATM                VASPCategory = 1
	VASPCategory_EXCHANGE           VASPCategory = 2
	VASPCategory_HIGH_RISK_EXCHANGE VASPCategory = 3
)

// Enum value maps for VASPCategory.
var (
	VASPCategory_name = map[int32]string{
		0: "UNKNOWN_VASP",
		1: "ATM",
		2: "EXCHANGE",
		3: "HIGH_RISK_EXCHANGE",
	}
	VASPCategory_value = map[string]int32{
		"UNKNOWN_VASP":       0,
		"ATM":                1,
		"EXCHANGE":           2,
...
func (x VASPCategory) Enum() *VASPCategory {
	p := new(VASPCategory)
	*p = x
	return p
}

func (x VASPCategory) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (VASPCategory) Descriptor() protoreflect.EnumDescriptor {
	return file_trisa_gds_models_v1beta1_models_proto_enumTypes[1].Descriptor()
}

func (VASPCategory) Type() protoreflect.EnumType {
	return &file_trisa_gds_models_v1beta1_models_proto_enumTypes[1]
}

func (x VASPCategory) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use VASPCategory.Descriptor instead.
func (VASPCategory) EnumDescriptor() ([]byte, []int) {
...
func (ServiceState) Descriptor() protoreflect.EnumDescriptor {
	return file_trisa_gds_models_v1beta1_models_proto_enumTypes[3].Descriptor()
}

func (ServiceState) Type() protoreflect.EnumType {
	return &file_trisa_gds_models_v1beta1_models_proto_enumTypes[3]
}
...
type VASP struct {
	...
	VaspCategory     VASPCategory     `protobuf:"varint,11,opt,name=vasp_category,json=vaspCategory,proto3,enum=trisa.gds.models.v1beta1.VASPCategory" json:"vasp_category,omitempty"`
	...
	Version uint64 `protobuf:"varint,20,opt,name=version,proto3" json:"version,omitempty"`
	...
	AdminVerificationToken string `protobuf:"bytes,21,opt,name=admin_verification_token,json=adminVerificationToken,proto3" json:"admin_verification_token,omitempty"`
}
...
func (x *VASP) GetVaspCategory() VASPCategory {
	if x != nil {
...
func (x *VASP) GetAdminVerificationToken() string {
	if x != nil {
...
type Contact struct {
	...
	Person *ivms101.NaturalPerson `protobuf:"bytes,6,opt,name=person,proto3" json:"person,omitempty"`
}
...
type TRIXOQuestionnaire struct {
	...
	MustComplyTravelRule bool `protobuf:"varint,8,opt,name=must_comply_travel_rule,json=mustComplyTravelRule,proto3" json:"must_comply_travel_rule,omitempty"`
	// Applicable Travel Regulations the VASP must comply with.
	ApplicableRegulations []string `protobuf:"bytes,9,rep,name=applicable_regulations,json=applicableRegulations,proto3" json:"applicable_regulations,omitempty"`
	// What is the minimum threshold for travel rule compliance?
	ComplianceThreshold float32 `protobuf:"fixed32,10,opt,name=compliance_threshold,json=complianceThreshold,proto3" json:"compliance_threshold,omitempty"`
	// Is the VASP required by law to safeguard PII?
	MustSafeguardPii bool `protobuf:"varint,11,opt,name=must_safeguard_pii,json=mustSafeguardPii,proto3" json:"must_safeguard_pii,omitempty"`
	// Does the VASP secure and protect PII, including PII received from other VASPs
	// under the Travel Rule? (yes/no)
	SafeguardsPii string `protobuf:"bytes,12,opt,name=safeguards_pii,json=safeguardsPii,proto3" json:"safeguards_pii,omitempty"`
}
...
func (x *TRIXOQuestionnaire) GetSafeguardsPii() string {
	if x != nil {
...
var file_trisa_gds_models_v1beta1_models_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x73, 0x5f, 0x70, 0x69, 0x69, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x73, 0x61, 0x66,
	...
	,
	...
	0x4c, 0x54, 0x48, 0x59, 0x10, 0x02, 0x12, 0x0a, 0x0a, 0x06, 0x44, 0x41, 0x4e, 0x47, 0x45, 0x52,
	...
	0x72, 0x69, 0x73, 0x61, 0x63, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x2f, 0x74, 0x72, 0x69, 0x73, 0x61,
	0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x74, 0x72, 0x69, 0x73, 0x61, 0x2f, 0x67, 0x64, 0x73, 0x2f, 0x6d,
	0x6f, 0x64, 0x65, 0x6c, 0x73, 0x2f, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x3b, 0x6d, 0x6f,
...
var file_trisa_gds_models_v1beta1_models_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_trisa_gds_models_v1beta1_models_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_trisa_gds_models_v1beta1_models_proto_goTypes = []interface{}{
	...
	(VASPCategory)(0),             // 1: trisa.gds.models.v1beta1.VASPCategory
	(VerificationState)(0),        // 2: trisa.gds.models.v1beta1.VerificationState
	(ServiceState)(0),             // 3: trisa.gds.models.v1beta1.ServiceState
	(*VASP)(nil),                  // 4: trisa.gds.models.v1beta1.VASP
	(*Contacts)(nil),              // 5: trisa.gds.models.v1beta1.Contacts
	(*Contact)(nil),               // 6: trisa.gds.models.v1beta1.Contact
	(*TRIXOQuestionnaire)(nil),    // 7: trisa.gds.models.v1beta1.TRIXOQuestionnaire
	(*Jurisdiction)(nil),          // 8: trisa.gds.models.v1beta1.Jurisdiction
	(*ivms101.LegalPerson)(nil),   // 9: ivms101.LegalPerson
	(*Certificate)(nil),           // 10: trisa.gds.models.v1beta1.Certificate
	(*ivms101.NaturalPerson)(nil), // 11: ivms101.NaturalPerson
}
var file_trisa_gds_models_v1beta1_models_proto_depIdxs = []int32{
	...
	5,  // 1: trisa.gds.models.v1beta1.VASP.contacts:type_name -> trisa.gds.models.v1beta1.Contacts
	...
	1,  // 5: trisa.gds.models.v1beta1.VASP.vasp_category:type_name -> trisa.gds.models.v1beta1.VASPCategory
	7,  // 6: trisa.gds.models.v1beta1.VASP.trixo:type_name -> trisa.gds.models.v1beta1.TRIXOQuestionnaire
	2,  // 7: trisa.gds.models.v1beta1.VASP.verification_status:type_name -> trisa.gds.models.v1beta1.VerificationState
	3,  // 8: trisa.gds.models.v1beta1.VASP.service_status:type_name -> trisa.gds.models.v1beta1.ServiceState
	6,  // 9: trisa.gds.models.v1beta1.Contacts.technical:type_name -> trisa.gds.models.v1beta1.Contact
	6,  // 10: trisa.gds.models.v1beta1.Contacts.administrative:type_name -> trisa.gds.models.v1beta1.Contact
	6,  // 11: trisa.gds.models.v1beta1.Contacts.legal:type_name -> trisa.gds.models.v1beta1.Contact
	6,  // 12: trisa.gds.models.v1beta1.Contacts.billing:type_name -> trisa.gds.models.v1beta1.Contact
	11, // 13: trisa.gds.models.v1beta1.Contact.person:type_name -> ivms101.NaturalPerson
	8,  // 14: trisa.gds.models.v1beta1.TRIXOQuestionnaire.other_jurisdictions:type_name -> trisa.gds.models.v1beta1.Jurisdiction
