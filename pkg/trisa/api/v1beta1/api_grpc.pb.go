...
func (c *tRISANetworkClient) Transfer(ctx context.Context, in *SecureEnvelope, opts ...grpc.CallOption) (*SecureEnvelope, error) {
	...
	err := c.cc.Invoke(ctx, TRISANetwork_Transfer_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tRISANetworkClient) TransferStream(ctx context.Context, opts ...grpc.CallOption) (TRISANetwork_TransferStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &TRISANetwork_ServiceDesc.Streams[0], TRISANetwork_TransferStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *tRISANetworkClient) ConfirmAddress(ctx context.Context, in *Address, opts ...grpc.CallOption) (*AddressConfirmation, error) {
	...
	err := c.cc.Invoke(ctx, TRISANetwork_ConfirmAddress_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tRISANetworkClient) KeyExchange(ctx context.Context, in *SigningKey, opts ...grpc.CallOption) (*SigningKey, error) {
	out := new(SigningKey)
	err := c.cc.Invoke(ctx, TRISANetwork_KeyExchange_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tRISAHealthClient) Status(ctx context.Context, in *HealthCheck, opts ...grpc.CallOption) (*ServiceState, error) {
	...
	err := c.cc.Invoke(ctx, TRISAHealth_Status_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
