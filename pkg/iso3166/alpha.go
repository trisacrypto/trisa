...
func init() {
	...
	countries = make(map[string]*AlphaCode)
	alpha3 = make(map[string]*AlphaCode)
	alpha2 = make(map[string]*AlphaCode)
	numeric = make(map[string]*AlphaCode)

	for _, code := range data {
		countries[code.Country] = code
		alpha2[code.Alpha2] = code
		alpha3[code.Alpha3] = code
...
// Lookup mappings
var (
	countries map[string]*AlphaCode
	alpha2    map[string]*AlphaCode
	alpha3    map[string]*AlphaCode
	numeric   map[string]*AlphaCode
)
...
// Find a country alpha code by the country name, 2 or 3 digit alpha code, or
// numeric code. An error is returned if the country can't be found.
